...
class Test_shenqingchanjia_bohui(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if tishi == True:
            ...
            time.sleep(3)
            self.login.login_to_index_page(zhanghao=22399)
        self.bohui = shangjishenpi_shenqing_chanjia_page(self.driver)

    def tearDown(self):
        self.driver.quit()

    def test_shenqingchanjia_bohui(self):

        self.bohui.shenqingchanjia_bohui()
