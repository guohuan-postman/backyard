...
class Test_shenqingnianjia_bohui(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if tishi == True:
            ...
            time.sleep(3)
            self.login.login_to_index_page(zhanghao=22399)
        self.nianjia_bohui = shangjishenpi_shenqing_nianjia_page(self.driver)

    def tearDown(self):
        self.driver.quit()

    def test_shenqingnianjia_bohui(self):

        self.nianjia_bohui.shenqingnianjia_bohui()
