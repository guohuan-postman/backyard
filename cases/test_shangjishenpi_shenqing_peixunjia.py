...
from pages.shangjishenpi_shenqing_nianjia_page import shangjishenpi_shenqing_nianjia_page
from pages.shangjishenpi_shenqing_peixunjia_page import shangjishenpi_shenqing_peixunjia_page


class Test_shenqing_peixunjia_bohui(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if tishi == True:
            ...
            time.sleep(3)
            self.login.login_to_index_page(zhanghao=22399)
        self.peixunjia_bohui = shangjishenpi_shenqing_peixunjia_page(self.driver)

    def tearDown(self):
        self.driver.quit()

    def test_shenqingpeixunjia_bohui(self):

        self.peixunjia_bohui.shenqing_peixunjia_bohui()
