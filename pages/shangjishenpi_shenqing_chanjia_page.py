...
class shangjishenpi_shenqing_chanjia_page(BasePage):
    def __init__(self,appium_driver):
        self.base_page = BasePage(appium_driver)

    def shenqingchanjia_bohui(self):
        ...
        print(cots)
        print('点击请假类型后：')
        # 点击产假（带薪）按钮,修改请假类型，只需要更改后边的li的下标
        ...
        a = read_yaml_file('shenqingchanjia_bohui', 'startTime')
        ...
        b = read_yaml_file('shenqingchanjia_bohui', 'endTime')
