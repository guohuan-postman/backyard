...
class shangjishenpi_shenqing_chanjianjia_page(BasePage):
    def __init__(self,appium_driver):
        self.base_page = BasePage(appium_driver)

    def shenqingchanjianjia_bohui(self):
        ...
        a = read_yaml_file('shenqingchanjianjia_bohui', 'startTime')
        ...
        ''' 位置信息  [771,1473][918,1608]'''
        b = read_yaml_file('shenqingchanjianjia_bohui', 'endTime')
        ...
        time.sleep(2)
        # 输入请假原因
        self.base_page.find_byxpath('//*[@id="app"]/div/div[1]/div[6]/textarea').send_keys('产检假两天-请假的原因')
        time.sleep(2)
        # 浏览器页面需要向上滑动一下
